<div class="container">
  <div class="row">
    <div class="col-md-2 col-sm-2">
        <div class="logo"><a href="index.html"><img src="/static/img/logo.png" alt="FlatShop"></a></div>
    </div>
        ...
        <div class="header_bottom">
          <ul class="option">
              ...
              <li class="option-cart">
                <a href="#" class="cart-icon">cart <span class="cart_no" id="count-cart">02</span></a>
                    ...
                    <li class="">
                      <div class="cart-item">
                          ...
                          <div class="item-description">
                            <p class="name"></p>
                            <p>Quantity: <span class="light-red" id=""></span></p>
                          </div>
                          <div class="right">
                            <p class="price" id="total-price-"> $</p>
                            <a href="javascript:void(0)" class="remove"  data-id="" data-total-price = ""><img src="/static/img/remove.png" alt="remove"></a>
                          </div>
                      </div>
                    </li>
                    <li><span class="total">Total <strong id="subcar-total"></strong></span><button class="checkout" onClick="location.href='checkout.html'">CheckOut</button></li>
                </ul>
              </li>
          </ul>
